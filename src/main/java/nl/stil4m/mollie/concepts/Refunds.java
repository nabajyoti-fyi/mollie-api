...
public class Refunds extends AbstractConcept<Refund> implements ListAll<Refund> {
	...
	public Refunds(String apiKey, String endpoint, RequestExecutor requestExecutor) { super(apiKey, requestExecutor, SINGLE_TYPE, PAGE_TYPE, new String[] { endpoint, "refunds" }); }
}
