...
public class CustomerMandates extends AbstractConcept<Mandate> implements ListAll<Mandate>, GetById<Mandate>, Create<Mandate, CreateMandate>, Delete<Mandate> {
	...
	public CustomerMandates(String apiKey, String endpoint, RequestExecutor requestExecutor, String customerId) { super(apiKey, requestExecutor, SINGLE_TYPE, PAGE_TYPE, new String[] { endpoint, "customers", customerId, "mandates" }); }
}
