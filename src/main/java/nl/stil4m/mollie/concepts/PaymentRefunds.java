...
public class PaymentRefunds extends AbstractConcept<Refund> implements ListAll<Refund>, GetById<Refund>, Create<Refund, CreateRefund>, Delete<Refund> {
	public PaymentRefunds(String apiKey, String endpoint, RequestExecutor requestExecutor, String paymentId) { super(apiKey, requestExecutor, Refunds.SINGLE_TYPE, Refunds.PAGE_TYPE, new String[] { endpoint, "payments", paymentId, "refunds" }); }
}
