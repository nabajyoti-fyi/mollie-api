...
public class Methods extends AbstractConcept<Method> implements ListAll<Method>, GetById<Method> {
	...
	public Methods(String apiKey, String endpoint, RequestExecutor requestExecutor) { super(apiKey, requestExecutor, SINGLE_TYPE, PAGE_TYPE, new String[] { endpoint, "methods" }); }
}
